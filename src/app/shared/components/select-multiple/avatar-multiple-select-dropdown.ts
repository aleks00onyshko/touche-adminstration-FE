  ...
  providers: [
    {
      ...
      useExisting: forwardRef(() => SelectMultipleExample), // tslint:disable-line
      multi: true
    },
    {
...
export class SelectMultipleExample extends ReactiveComponent implements OnInit, ControlValueAccessor, Validator {
